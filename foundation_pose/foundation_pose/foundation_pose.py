...
class foundationPose(Node):
    ...
    def __init__(self):
        ...
        self.T_cam2gripper = np.array([
           [ -0.71451674,  -0.69947352, 0.01423476,   0.04051642],
           [ 0.69960197, -0.71449134,  0.00769545,  0.04491512],
        ...
        self.declare_parameter('foundation_pose_library_directory', 'Moveit_ur5e_ros2-with-cartesian-path-planning/ur5e_ws/src/vision_based_position_estimation/foundation_pose/foundation_pose/lib')
        self.declare_parameter('foundation_pose_src_directory', 'Moveit_ur5e_ros2-with-cartesian-path-planning/ur5e_ws/src/vision_based_position_estimation/foundation_pose/foundation_pose/lib/FoundationPose')
        self.declare_parameter('cutie_library_directory', 'Moveit_ur5e_ros2-with-cartesian-path-planning/ur5e_ws/src/vision_based_position_estimation/foundation_pose/foundation_pose/lib/Cutie')
